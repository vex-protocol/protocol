...
export {
    type FederationAccountQuery,
    FederationAccountQuerySchema,
    type FederationAccountResult,
    FederationAccountResultSchema,
    type FederationDevice,
    FederationDeviceSchema,
    type FederationInvitePreview,
    FederationInvitePreviewSchema,
    type FederationInviteQuery,
    FederationInviteQuerySchema,
    type FederationInviteRedeemQuery,
    FederationInviteRedeemQuerySchema,
    type FederationInviteRedeemResult,
    FederationInviteRedeemResultSchema,
    type FederationInviteReference,
    type FederationKeyBundleQuery,
    FederationKeyBundleQuerySchema,
    type FederationKeyBundleResult,
    FederationKeyBundleResultSchema,
    type FederationMailEnvelope,
    FederationMailEnvelopeSchema,
    type FederationMailResult,
    FederationMailResultSchema,
    type FederationMigrationAuthorization,
    type FederationMigrationAuthorizationInput,
    FederationMigrationAuthorizationInputSchema,
    FederationMigrationAuthorizationSchema,
    type FederationMigrationAvatarReference,
    FederationMigrationAvatarReferenceSchema,
    type FederationMigrationBlobResult,
    FederationMigrationBlobResultSchema,
    type FederationMigrationChallenge,
    FederationMigrationChallengeSchema,
    type FederationMigrationCompleteResult,
    FederationMigrationCompleteResultSchema,
    type FederationMigrationFileQuery,
    FederationMigrationFileQuerySchema,
    type FederationMigrationFileReference,
    FederationMigrationFileReferenceSchema,
    type FederationMigrationImportRequest,
    FederationMigrationImportRequestSchema,
    type FederationMigrationImportResult,
    FederationMigrationImportResultSchema,
    type FederationMigrationMailEntry,
    FederationMigrationMailEntrySchema,
    type FederationMigrationMailPage,
    FederationMigrationMailPageSchema,
    type FederationMigrationMailQuery,
    FederationMigrationMailQuerySchema,
    type FederationMigrationManifest,
    FederationMigrationManifestSchema,
    type FederationMigrationPrepareResult,
    FederationMigrationPrepareResultSchema,
    type FederationMigrationQuery,
    FederationMigrationQuerySchema,
    type FederationMigrationRoomReference,
    FederationMigrationRoomReferenceSchema,
    type FederationRoomDeletion,
    FederationRoomDeletionSchema,
    type FederationRoomInvitesQuery,
    FederationRoomInvitesQuerySchema,
    FederationRoomInvitesResultSchema,
    type FederationRoomMailAuthorization,
    type FederationRoomMailAuthorizationQuery,
    FederationRoomMailAuthorizationQuerySchema,
    FederationRoomMailAuthorizationSchema,
    type FederationRoomMember,
    FederationRoomMemberSchema,
    type FederationRoomMutation,
    type FederationRoomMutationQuery,
    FederationRoomMutationQuerySchema,
    type FederationRoomMutationResult,
    FederationRoomMutationResultSchema,
    type FederationRoomPushResult,
    FederationRoomPushResultSchema,
    type FederationRoomSnapshot,
    type FederationRoomSnapshotQuery,
...
export {
    ...
    type RegistryHomeserver,
    RegistryHomeserverSchema,
    type RegistryIdentityResolution,
